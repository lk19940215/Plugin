...
(function(window, document) {
	...
	DrawHistogram.prototype = {
		...
		cSys: function() {
			...
			ctx.textAlign = "start";
			ctx.textBaseline = "bottom";
			var h = 18; //Math.ceil(this.H * 0.04);
			options.xAis.forEach(function(item, index) {
		...
		top: function() {
			...
			maxLengthArr = options.dataArr.reduce(function(prev, cur, index) {
				var maxLengthArr = [];
